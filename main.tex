...
\citet{nguyen:2024:UsingGPT4Provide} demonstrate the feasibility of using GPT-4 for tiered, formative feedback on programming exercises in introductory courses, showing it can generate useful feedback on conceptual understanding, syntax, and time complexity using few-shot learning with sample solutions for Java algorithm tasks. Similarly, our DAFeeD approach uses GPT-4 but is fully integrated into an LMS, enabling students to automatically receive formative feedback on various exercise types multiple times before assessment. Additionally, our feedback references specific segments of the submission and guides students toward solutions without revealing them, enhancing the overall feedback experience and supporting continuous improvement.
