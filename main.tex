...
When submitting their solutions on LMS, students have the option to request direct automated feedback by clicking a dedicated button.
...
Once FeedbackSystem generates the feedback and sends it back to LMS, the student can review it in an inline feedback view window on LMS.
...
\begin{figure}[htbp]
  ...
  \caption{Visualization of the inline feedback interface for text exercises in the LMS as seen by students.}
...
During this stage, quantitative data were collected to evaluate both student performance and system effectiveness in a real-world educational setting.
...
Incorporating more advanced AI techniques, such as Chain-of-Thought \cite{wei:2022:ChainofThoughtPromptingElicits}, ReAct \cite{yao:2023:ReActSynergizingReasoning}, Retrieval-Augmented Generation \cite{gao:2024:RetrievalAugmentedGenerationLarge},
...
Addressing the issue of AI hallucinations, a Retrieval-Augmented Generation (RAG) approach can be employed to enhance accuracy \cite{gao:2024:RetrievalAugmentedGenerationLarge}.
