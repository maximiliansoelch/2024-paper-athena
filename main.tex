...
\begin{figure}[!htbp]
  ...
  # Task
  Create graded feedback suggestions for a student's programming submission that a human tutor would accept. Meaning, the feedback you provide should be appliable to the submission with little to no modification.
  ...
  %*\highlight{\{grading\_instructions\}}*)
  Max points: %*\highlight{\{max\_points\}}*), bonus points: %*\highlight{\{bonus\_points\}}*) (whole assessment, not just this file)
  
  # Diff between solution (deletions) and student's submission (additions):
  %*\highlight{\{solution\_to\_submission\_diff\}}*)
  ...
  """
  %*\highlight{\{submission\_file\}}*)
  """
  \end{lstlisting}
  \caption[Prompt for Generating Feedback Suggestions for Programming Exercises]{Prompt for Generating Feedback Suggestions for Programming Exercises. The highlighted sections are placeholders for the respective elements.}
...
%   \centering
%   \resizebox{\textwidth}{!}{
%     \input{figures/likert_responses_stacked.pgf}
%   }
%   \caption[Distribution of Likert scale responses]{Distribution of Likert scale responses.}
% \end{figure}
...
\begin{figure}[htpb]
  ...
  \resizebox{0.8\textwidth}{!}{
    \input{figures/likert_responses_stacked_percentage.pgf}
  }
  \caption[Distribution of Likert scale responses]{Distribution of Likert scale responses.}
\end{figure}
