...
The defined feedback process enables interactive learning by allowing students to submit solutions multiple times and request iterative feedback before deadlines.
...
To evaluate the feedback process, we implemented it as an open-source reference implementation integrated into the learning platform LP.
