...
% Felix:
% - Anonymization seems to be done
% - Called it component diagram instead of deployment diagram
% - LMS could be replaced with Learning Management System (Large Language Model is also not shortened to LLM)
