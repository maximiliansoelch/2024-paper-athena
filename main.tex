...
In their systematic review of 101 tools for automated feedback on programming exercises, \citet{keuning:2018:SystematicLiteratureReview} found that most tools primarily identify mistakes rather than provide guidance on how to fix them or proceed further. Additionally, they noted a lack of adaptability to teachers' specific needs. This review highlights the need for feedback mechanisms that offer more actionable advice. Building on this, our DAFeeD system leverages recent advancements in LLMs to provide iterative, customized feedback that not only identifies errors but also offers actionable guidance, enhancing continuous student improvement.
