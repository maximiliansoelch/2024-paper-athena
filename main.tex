...
\citet{barke:2023:GroundedCopilotHow} present findings on how programmers interact with code-generating models like GitHub Copilot, identifying bimodal interaction patterns: acceleration and exploration modes. These insights inform our approach to designing feedback systems that can cater to varying levels of student expertise and confidence. \citet{bucinca:2021:TrustThinkCognitive} explored cognitive forcing functions to reduce overreliance on AI in decision-making, suggesting that similar interventions might be necessary to ensure students critically engage with automated feedback rather than passively accepting it.
