...
This paper presents DAFeeD, an LLM-based approach for automated formative feedback on student submissions in various exercise domains.
...
By incorporating the task, the grading criteria and the student submission into the prompt, DAFeeD provides clear and personalized feedback iteratively, facilitating continuous student improvement.
